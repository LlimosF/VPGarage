<?php
  ...
  // On inclu le header pour la page d'accueil

  require_once("Composants/Header.php");

  // On inclu le fond du site web
...
<?php
  ...
  // On inclu le bandeau de réparation

  require_once("Composants/BoucleBandeau.php");

  // On inclu le script pour pouvoir ajouter des commentaires
...
<?php
  ...
  // On ajoute tous les commentaires récupéré dans la base de donnée
...
<?php
  ...
  // On inclu le footer pour la page d'accueil
